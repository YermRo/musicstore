...
<fmt:bundle basename="i18n">
    <fmt:message key="common.pageNumber" var="page_number"/>
    <fmt:message key="common.productsOnPage" var="products_on_page"/>
</fmt:bundle>
    ...
    <div class="col">
        <div class="row justify-content-center">
            ...
            <div class="col-4"  style="padding-right: 0px">
                <p class="text-secondary" style="font-size: 17px; margin:1px; vertical-align: middle">
                    ${products_on_page}
                </p>
            </div>
