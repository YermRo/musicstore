...
<c:url var="addProduct_url" value="/do/manage/addProduct"/>
...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-7">
            <form role="form" action="${addProduct_url}" method="post" enctype="multipart/form-data" c>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 p-0">
                            ...
                            <select class="form-control custom-select " id="lang" name="descriptionLanguage">
                                <option selected name="descriprionLanguage" value="${descriptionLanguage}">
                                    ${select_description_message}
                                </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 p-0">
                            ...
                            <c:if test="${imageError.equals('true')}">
                                <p class="text-danger" style="font-size: 14px; margin:1px">${imageErrorMessage}</p>
                            </c:if>
                        </div>
                    </div>
                </div>
